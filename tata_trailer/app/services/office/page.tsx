      ...
      description: (
        <>
          <p>
            ...
            building across town or relocating to a different city, our experienced team
            and modern fleet ensure that your office equipment and furniture are
            transported safely and securely.
          </p>
          <br />
          <p>
            Our services include packing and unpacking, disassembly and reassembly of
            office furniture, and secure transportation of all office items, including
            computers, documents, and equipment. We adhere to the highest standards of
            care and professionalism, ensuring that your office setup is operational at
            the new location with minimal downtime.
          </p>
          <br />
          <p>
            With years of experience in the logistics industry, Tata Trailer is your
            trusted partner for all your office moving needs. Our team of skilled
            professionals is dedicated to providing personalized service and support,
            ensuring a smooth and stress-free relocation experience from start to finish.
          </p>
        </>
      ),      
