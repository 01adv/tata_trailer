const content = [
    {
      ...
      description: (
        <>
          <p>
            Tata Trailer Agricultural Equipment Transport Services specializes in the
            logistics and transportation of heavy agricultural machinery via road. Our
            extensive fleet of modern trailers and heavy-duty vehicles ensures that we
            can handle the transport of machinery of all sizes and weights with utmost
          ...
          <p>
            ...
            machinery to remote rural locations. We adhere to the highest standards of
            safety and regulatory compliance, ensuring that your equipment arrives at
            its destination on time and in perfect condition.
          </p>
          <br />
          <p>
            With years of experience in the logistics industry, Tata Trailer is your
            trusted partner for all your agricultural transport needs. Our team of
            skilled professionals is dedicated to providing personalized service and
            support, ensuring a seamless transport experience from start to finish.
          </p>
        </>
      ),
