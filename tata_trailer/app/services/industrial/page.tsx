const content = [
  {
    title: "Tata Trailor Industrial Machinery Transport Services",
    description: (
      <>
        <p>
        ...
        <br />
        <p>
          Our services include the transportation of oversized equipment,
          factory relocations, and the delivery of construction machinery to
          remote locations. We adhere to the highest standards of safety and
          regulatory compliance, ensuring that your machinery arrives at its
